                      ...
                      <a key={item.nb_id} href={item.nb_href} target="_blank" className="group">
                        <div className="aspect-w-2 aspect-h-1 w-full overflow-hidden rounded-lg xl:aspect-w-7 xl:aspect-h-8">
                          ...
                          <div>
                            ...
                            {item.nb_dis_price === null || (item.nb_dis_price === item.nb_price_srp) ? "": <p className=" pr-4 line-through leading-none text-md text-left font-normal text-gray-500"><NumericFormat value={item.nb_price_srp} thousandSeparator="," displayType="text" />.-</p>}
                            <p className="leading-normal text-2xl text-left font-bold text-red-600"><NumericFormat value={item.nb_dis_price} thousandSeparator="," displayType="text" />.-</p>
